...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      home: Scaffold(
        backgroundColor: const Color.fromARGB(255, 186, 125, 182),
        appBar: AppBar(title: const Text('App - Putri Kamila')),
        ...
        children: [
          ...
          const Text(
            ...
            style: TextStyle(
              ...
              shadows: [
                Shadow(
                  blurRadius: 5.0,
                  color: Color.fromARGB(224, 250, 0, 250),
          ...
          Row(
            ...
            children: [
              ...
              // Gambar dari URL
              Image.network(
                'https://stickerly.pstatic.net/sticker_pack/lLqqpGrXIyhHMg8qKp3OUw/VA5KNM/3/8a7908d5-a452-4a86-8cbc-9203c7f459f5.png',
                width: 150,
                errorBuilder: (context, error, stackTrace) {
                  return const Text(
